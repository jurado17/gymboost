<template>
    <nav
        class="bg-white border-b border-gray-200 px-4 py-4 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <Link :href="route('admin.dashboard')" class="flex items-center justify-between mr-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">GymBoost</span>
                </Link>
            </div>
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li
                            ...
                            <Link :href="route('logout')" method="post" as="button">Sign out
                            </Link>
                        </li>
                    </ul>
                </div>
