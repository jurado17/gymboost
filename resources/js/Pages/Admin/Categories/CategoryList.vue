...
//metodo para añadir un categoryo nuevo
...
//metodo para abrir el modal para editar un categoryo
...
//Metodo para actualizar un category
...
Swal.fire({
    ...
    if (result.isConfirmed) {
        try {
            router.delete('categories/delete/' + category.id, {
                onSuccess: (page) => {
...
<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="filterDropdown"
                                ...
                                <ul v-for="category in categories" :key="category.id" class="space-y-2 text-sm"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="category in categories" :key="category.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ new Date(category.updated_at).toLocaleDateString() }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="dropdown-button-{{ category.id }}" :data-dropdown-toggle="category.id"
    ...
    <!--MODAL-->
    <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit category' : 'Add category'" width="700">
        <form @submit.prevent="editMode ? updateCategory() : addCategory()">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <p>Este es el texto por el que se busca la Marca</p>
                </div>
            </div>
