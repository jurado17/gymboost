...
//metodo para añadir un brando nuevo
...
//metodo para abrir el modal para editar un brando
...
const deleteBrand = (brand, index) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            try {
                router.delete('brands/delete/' + brand.id, {
                    onSuccess: (page) => {
...
<template>
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="filterDropdown"
                                ...
                                <ul v-for="brand in brands" :key="brand.id" class="space-y-2 text-sm"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="brand in brands" :key="brand.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ new Date(brand.updated_at).toLocaleDateString() }}</td>
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="dropdown-button-{{ brand.id }}" :data-dropdown-toggle="brand.id"
    ...
    <!--MODAL-->
    <el-dialog v-model="dialogVisible" :title="editMode ? 'Edit Brand' : 'Add Brand'" width="700">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Slug</label>
                    <input v-model="slug" type="text" name="slug" id="slug"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="" required="">
                    <p>Este es el texto por el que se busca la barca</p>
                </div>
            </div>
