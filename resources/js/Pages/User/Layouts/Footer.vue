...
<footer class="p-6 bg-gray-900 text-white sm:p-6 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm  sm:text-center dark:">© 2022 <a
                        :href="route('user.home')" class="hover:underline">GymBoost™</a>. All Rights Reserved.
                </span>
